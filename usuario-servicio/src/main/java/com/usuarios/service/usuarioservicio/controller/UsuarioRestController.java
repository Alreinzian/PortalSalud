package com.usuarios.service.usuarioservicio.controller;
...
import com.usuarios.service.usuarioservicio.service.UsuarioService;
...
public class UsuarioRestController {
    ...
    public ResponseEntity<Object> buscarPorId(@PathVariable("id") int id) {
        ...
        if (usuario == null)
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Usuario no encontrado, el ID proporcionado no es correcto");
